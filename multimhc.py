...
from utils import Fusion_datamodule, hla_dic
import yaml
import sys
import time
import logging
...
def predict(device=None, argv=sys.argv[1:]):
    ...
    seqs, peps, hlas = process_data(input_df)
    ...
    for fold_idx in range(1, 6):
        ...
        model = Fusion_PL(config=config, total_steps=t_total, device=device)
